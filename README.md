...
<h2> Installation </h2>
<br>
-to install simply create a new .sh file from your favorite text file editor (vim for example), name it whatever you like and copy the code from the bash script files in the main repository labeled Wifi bash script (Monitor Mode)/(Startup Recovery) then paste them to their own .sh files. Save the file.
<br><br>
